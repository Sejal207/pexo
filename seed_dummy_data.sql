-- =====================================================================
-- Pexo — Comprehensive Seed & Dummy Data Script
...
INSERT INTO employee (
  ...
  ('e0000000-0000-0000-0000-000000000001', 'E001', 'Alice', 'Smith', 'alice.smith@Pexo.com', '+15550101', '1988-03-15', 'Female', '2022-01-10', 'd0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0001-000000000001', 'ACTIVE'),
  ('e0000000-0000-0000-0000-000000000002', 'E002', 'Bob', 'Johnson', 'bob.johnson@Pexo.com', '+15550102', '1990-07-22', 'Male', '2022-03-01', 'd0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0001-000000000001', 'ACTIVE'),
  ('e0000000-0000-0000-0000-000000000003', 'E003', 'Charlie', 'Davis', 'charlie.davis@Pexo.com', '+15550103', '1985-11-05', 'Male', '2021-06-15', 'd0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 'ACTIVE'),
  ('e0000000-0000-0000-0000-000000000004', 'E004', 'David', 'Miller', 'david.miller@Pexo.com', '+15550104', '1993-02-18', 'Male', '2023-01-09', 'd0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0001-000000000001', 'ACTIVE'),
  ('e0000000-0000-0000-0000-000000000005', 'E005', 'Eva', 'Wilson', 'eva.wilson@Pexo.com', '+15550105', '1995-09-30', 'Female', '2023-05-20', 'd0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0001-000000000001', 'ACTIVE');
...
VALUES
  ('a0000000-0000-0000-0000-000000000000', 'admin@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, NULL),
  ('a0000000-0000-0000-0000-000000000001', 'alice.hr@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, 'e0000000-0000-0000-0000-000000000001'),
  ('a0000000-0000-0000-0000-000000000002', 'bob.payroll@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, 'e0000000-0000-0000-0000-000000000002'),
  ('a0000000-0000-0000-0000-000000000003', 'charlie.lead@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, 'e0000000-0000-0000-0000-000000000003'),
  ('a0000000-0000-0000-0000-000000000004', 'david.dev@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, 'e0000000-0000-0000-0000-000000000004'),
  ('a0000000-0000-0000-0000-000000000005', 'eva.qa@Pexo.com', crypt('Password@123', gen_salt('bf')), TRUE, 'e0000000-0000-0000-0000-000000000005');
